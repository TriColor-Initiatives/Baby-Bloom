...
const HealthChat = ({ onSendMessage, isLoading, error, onSuggestionClick }) => {
    const [inputValue, setInputValue] = useState('');
    const [messages, setMessages] = useState([
        {
            id: 'welcome',
            role: 'assistant',
            content: "👋 Hi! I'm your baby health assistant. I provide short, actionable answers about:\n\n• Symptom assessment (when to call doctor)\n• Medication questions\n• Vaccination info\n• Emergency guidance\n• Growth concerns\n\n⚠️ **Important:** This is not a substitute for professional medical advice. Always consult your pediatrician for medical concerns.\n\nWhat can I help with?",
            timestamp: new Date()
        }
    ]);
                        ...
                        try {
                            ...
                            setMessages(prev => {
                                ...
                                return [...filtered, {
                                    ...
                                    role: 'assistant',
                                    content: response || "I'm here to help with baby health questions! Ask me about symptoms, medications, or vaccinations.",
                                    timestamp: new Date()
                                }];
                            });
                        } catch (err) {
            ...
            <div className="chat-header">
                <div className="chat-header-left">
                    ...
                    <div className="chat-header-content">
                        <h3 className="chat-header-title">Baby Health Assistant</h3>
                        <p className="chat-header-subtitle">Get guidance on symptoms, medications & vaccinations</p>
                    </div>
                </div>
            ...
            <form className="chat-input-container" onSubmit={handleSend}>
                <div className="chat-input-wrapper">
                    <input
                        ...
                        placeholder="Ask about symptoms, medications, vaccinations, emergencies, or growth concerns..."
                        value={inputValue}
