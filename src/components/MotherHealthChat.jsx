...
const MotherHealthChat = ({ onSendMessage, isLoading, error, onSuggestionClick }) => {
    const [inputValue, setInputValue] = useState('');
    const [messages, setMessages] = useState([
        {
            id: 'welcome',
            role: 'assistant',
            content: "👋 Hi! I'm your postpartum wellness assistant. I provide short, actionable answers about:\n\n• Recovery & healing\n• Self-care tips\n• Emotional wellness\n• Physical health\n\n**Note:** Always consult your healthcare provider for medical concerns.\n\nWhat can I help with?",
            timestamp: new Date()
        }
    ]);
                        ...
                        try {
                            ...
                            setMessages(prev => {
                                ...
                                return [...filtered, {
                                    ...
                                    role: 'assistant',
                                    content: response || "I'm here to help with your postpartum wellness! Ask me about recovery, self-care, or any concerns.",
                                    timestamp: new Date()
                                }];
                            });
                        } catch (err) {
            ...
            <div className="chat-header">
                <div className="chat-header-left">
                    ...
                    <div className="chat-header-content">
                        <h3 className="chat-header-title">Mother's Wellness Chat</h3>
                        <p className="chat-header-subtitle">Get support for postpartum recovery & self-care</p>
                    </div>
                </div>
            ...
            <form className="chat-input-container" onSubmit={handleSend}>
                <div className="chat-input-wrapper">
                    <input
                        ...
                        placeholder="Ask about postpartum recovery, self-care, or wellness..."
                        value={inputValue}
...
export default MotherHealthChat;
