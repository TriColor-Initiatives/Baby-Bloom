...
const SleepChat = ({ onSendMessage, isLoading, error, onSuggestionClick }) => {
    const [inputValue, setInputValue] = useState('');
    const [messages, setMessages] = useState([
        {
            id: 'welcome',
            role: 'assistant',
            content: "👋 Hi! I'm your sleep assistant. I provide short, practical answers about:\n\n• Sleep schedules by age\n• Troubleshooting (night wakings, short naps, sleep regression)\n• Sleep training methods\n• Nap transitions\n• Bedtime routines\n\nWhat can I help with?",
            timestamp: new Date()
        }
    ]);
                        ...
                        try {
                            ...
                            setMessages(prev => {
                                ...
                                return [...filtered, {
                                    ...
                                    role: 'assistant',
                                    content: response || "I'm here to help with sleep questions! Ask me about schedules, troubleshooting, or sleep training.",
                                    timestamp: new Date()
                                }];
                            });
                        } catch (err) {
            ...
            <div className="chat-header">
                <div className="chat-header-left">
                    ...
                    <div className="chat-header-content">
                        <h3 className="chat-header-title">Sleep Assistant</h3>
                        <p className="chat-header-subtitle">Get practical sleep guidance & troubleshooting</p>
                    </div>
                </div>
            ...
            <form className="chat-input-container" onSubmit={handleSend}>
                <div className="chat-input-wrapper">
                    <input
                        ...
                        placeholder="Ask about sleep schedules, troubleshooting, sleep training, or bedtime routines..."
                        value={inputValue}
