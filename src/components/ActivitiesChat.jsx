...
const ActivitiesChat = ({ onSendMessage, isLoading, error, onSuggestionClick }) => {
    const [inputValue, setInputValue] = useState('');
    const [messages, setMessages] = useState([
        {
            id: 'welcome',
            role: 'assistant',
            content: "👋 Hi! I'm your activity assistant. I provide short, practical answers about:\n\n• Age-appropriate activity suggestions\n• Developmental play ideas\n• Activity troubleshooting\n• Sensory play ideas\n• Motor skill development activities\n\nWhat can I help with?",
            timestamp: new Date()
        }
    ]);
                        ...
                        try {
                            ...
                            setMessages(prev => {
                                ...
                                return [...filtered, {
                                    ...
                                    role: 'assistant',
                                    content: response || "I'm here to help with activity questions! Ask me about age-appropriate activities or play ideas.",
                                    timestamp: new Date()
                                }];
                            });
                        } catch (err) {
            ...
            <div className="chat-header">
                <div className="chat-header-left">
                    ...
                    <div className="chat-header-content">
                        <h3 className="chat-header-title">Activity Assistant</h3>
                        <p className="chat-header-subtitle">Get age-appropriate play ideas & developmental activities</p>
                    </div>
                </div>
            ...
            <form className="chat-input-container" onSubmit={handleSend}>
                <div className="chat-input-wrapper">
                    <input
                        ...
                        placeholder="Ask about age-appropriate activities, play ideas, sensory play, or motor skills..."
                        value={inputValue}
