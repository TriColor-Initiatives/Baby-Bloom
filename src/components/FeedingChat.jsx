...
const FeedingChat = ({ onSendMessage, isLoading, error, onSuggestionClick }) => {
    const [inputValue, setInputValue] = useState('');
    const [messages, setMessages] = useState([
        {
            id: 'welcome',
            role: 'assistant',
            content: "👋 Hi! I'm your feeding assistant. I provide short, practical answers about:\n\n• Feeding schedules\n• Troubleshooting (refusal, gas, etc.)\n• Nutrition questions\n• Weaning guidance\n\nWhat can I help with?",
            timestamp: new Date()
        }
    ]);
                        ...
                        try {
                            ...
                            setMessages(prev => {
                                ...
                                return [...filtered, {
                                    ...
                                    role: 'assistant',
                                    content: response || "I'm here to help with feeding questions! Ask me about schedules, troubleshooting, or nutrition.",
                                    timestamp: new Date()
                                }];
                            });
                        } catch (err) {
            ...
            <div className="chat-header">
                <div className="chat-header-left">
                    ...
                    <div className="chat-header-content">
                        <h3 className="chat-header-title">Feeding Assistant</h3>
                        <p className="chat-header-subtitle">Get practical feeding guidance & troubleshooting</p>
                    </div>
                </div>
            ...
            <form className="chat-input-container" onSubmit={handleSend}>
                <div className="chat-input-wrapper">
                    <input
                        ...
                        placeholder="Ask about feeding schedules, troubleshooting, nutrition, or weaning..."
                        value={inputValue}
